...
⏺️ Method 1: QR Code Onboarding (Recommended)
...
4. The app automatically configures the server URL and API key
5. The device is then put in a "Pending Approval" state until the admin confirms it, ensuring maximum security.

⏺️ Method 2: Manual Registration (Fallback)
...
Approval Flow:
1. Registration request is sent to the server (via QR or Manual)
